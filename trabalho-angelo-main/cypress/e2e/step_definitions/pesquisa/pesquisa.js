...
When("Enter a city in the search field", () => {
  ...
  cy.get(
    ".envolve_logo.mobile-only > .largura-maxima > .nav-container > .pure-u-1 > #busca > .search > .form-inline > #mod-search-searchword"
  ).type("Joao pessoa");
  cy.get(
    ".envolve_logo.mobile-only > .largura-maxima > .nav-container > .pure-u-1 > #busca > .search > .form-inline > .button"
  ).click();
});
